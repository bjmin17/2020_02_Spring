...
public class AjaxController {
	 ...
	 * 업무를 처리하고
	 * 그렇지 않은 요청은 모두 무시하게 하는 패턴
	 * 
	 * 이 패턴을 사용하여 web 서비스를 만들려면
	 * 프로젝트의 web.xml의 appServlet url-pattern을 설정하고
	 * 대신 반드시 index.html, index.jsp 파일을 webapp 폴더에
	 * 작성해두어야 한다.
	 * 그래야 프로젝트가 톰캣에 의해서 run 되었을 때 
	 * 최초 404 오류가 나타나지 않는다.
	 * 
	 */
	@ResponseBody
	 ...
	 * 단, jacksonbind를 porm.xml에 dependency를 설정해 두어야 한다.
	 */
	@ResponseBody
