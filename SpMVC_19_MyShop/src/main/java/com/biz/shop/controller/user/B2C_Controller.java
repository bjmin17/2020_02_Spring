...
//		return "admin/main";
	...
	/*
	 * Authentication : 스프링 시큐리티으로 로그인된 사용자 정보 추출을 위한 인터페이스
	 */
	@ResponseBody
	...
	public Integer cart_list_delete(// @RequestParam("delList[]") String[] strSeqList
			@RequestParam("delList[]") List<String> strSeqList) {
		
//		List<String> seqList = new ArrayList<>(Arrays.asList(strSeqList));
