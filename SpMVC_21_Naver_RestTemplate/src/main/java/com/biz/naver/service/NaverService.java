...
public class NaverService {
	...
	public List<NaverVO> naverSearch(String cat, String search) throws UnsupportedEncodingException, URISyntaxException {
		...
		// RestTemplate으로 조회하기 위해 Header 값을 설정
		HttpHeaders header = new HttpHeaders();
		
		header.set("X-Naver-Client-Id",NaverConfig.NAVER_CLINET_ID);
		header.set("X-Naver-Client-Secret",NaverConfig.NAVER_CLINET_SECRET);
		...
		// 이렇게 하면 우리가 만든 VO에 자동으로 분배해서 받아준다( ,NaverSearchCover.class)
